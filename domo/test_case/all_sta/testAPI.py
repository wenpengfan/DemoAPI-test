...
from domo.lib.readexcel import ReadExcel
from domo.lib.sendrequests import SendRequests
from domo.lib.writeexcel import WriteExcel
...
class Demo_API(unittest.TestCase):
    ...
    def test_api(self,data):
        ...
        # 获取excel表格数据的状态码和消息,status_code(excel内预设状态)
